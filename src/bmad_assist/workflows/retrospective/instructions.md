...
- Developer (Amelia) facilitates this retrospective
...
<check if="{{prev_epic_num}} >= 1">
  ...
  <check if="previous retro found">
    <output>
Amelia (Developer): "I found our retrospective from Epic {{prev_epic_num}}. Let me see what we committed to back then..."
    </output>
...
<guideline>Amelia maintains psychological safety throughout - no blame or judgment</guideline>
