...
<workflow>
  ...
  <step n="3" goal="Detect review continuation and extract review context">
    ...
    <check if="Senior Developer Review section exists">
      ...
      <output>⏯️ **Resuming Story After Code Review** ({{review_date}})
        ...
        **Strategy:** Will prioritize review follow-up tasks (marked [Review][Patch], [Review][Decision], or legacy [AI-Review]) before continuing with regular tasks.
      </output>
    </check>
  ...
  <step n="8" goal="Validate and mark task complete ONLY when fully done">
    ...
    <check if="task is review follow-up (has [Review][Patch], [Review][Decision], or legacy [AI-Review] prefix)">
